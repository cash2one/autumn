"""
    ...
    Decorator same as: Doubler = Private('data', 'size')(Doubler).Private returns onDecorator,
    onDecorator returns onInstance,and each onInstance instance embeds a Doubler instance.
"""
...
def private(*privates):             # privates in enclosing scope
    def on_decorator(aClass):        # aClass in enclosing scope
        class OnInstance(object):           # wrapped in instance attribute
