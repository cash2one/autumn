...
class MySQLClient:
    def __init__(self, _db_host, _db_user, _db_passwd, _db_db, _port=3306):
        ...
        try:
            ...
            raise e.__class__(u'数据库连接失败: [{}]'.format(e))
...
if __name__ == '__main__':
    ...
    m = MySQLClient("122.144.134.95", "python_team", "python_team", "ada-fd")
    m.connect()

    sql_ = "select close_price from equity_price limit 10"
    print sql_
    res = m.query(sql_)
    print res
    print type(res)
